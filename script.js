...
<input id="stakeInput" type="number" value="2" style="
width:100%;
padding:8px;
border:none;
border-radius:10px;
...
<input id="profitInput" type="number" value="5" style="
width:100%;
padding:8px;
border:none;
border-radius:10px;
...
<input id="lossInput" type="number" value="10" style="
width:100%;
padding:8px;
border:none;
border-radius:10px;
...
<select id="martingaleSelect" style="
width:100%;
padding:8px;
border:none;
border-radius:10px;
